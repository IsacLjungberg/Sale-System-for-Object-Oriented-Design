...
import se.kth.salesystem.integration.AmountDiscount;
import se.kth.salesystem.integration.PercentDiscount;
...
public class PseudoDB {
    ...
    /**
     * Resets the database by initializing the sales, items, and discounts lists
     * with default values.
     */
